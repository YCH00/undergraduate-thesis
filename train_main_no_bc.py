...
from rlkit.torch.algo.gentle_no_bc import GENTLE
...
def experiment(variant, seed=None):
    ...
    context_encoder_input_dim = 2 * obs_dim + action_dim + reward_dim if variant['algo_params']['use_next_obs_in_context'] else obs_dim + action_dim + reward_dim + terminal_dim
